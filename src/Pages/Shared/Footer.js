...
const Footer = () => {
  return (
    <div>
      <footer className="footer footer-center p-5 bg-black text-neutral-content mb-0">
        <div className="items-center grid-flow-col dark:text-gray-100">
          ...
          <small>Copyright © 2022 - <span className='italic'>Photo Care</span></small>
        </div>
      </footer>
    </div>
  );
