  ...
  return (
    <div className='my-20'>
      ...
      <div className='w-[60%] mx-auto grid grid-cols-2'>
        <div className=''>
          <img className='h-[70%]' src="https://images.unsplash.com/photo-1556642389-0cd5fd882f5a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTV8fHBob3RvZ3JhcGhlcnxlbnwwfHwwfHw%3D&w=1000&q=80" alt="" />
        </div>
        <div>
